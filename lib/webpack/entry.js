...
function entryDev(filename, flags) {
  ...
  return {
    [entryName]: [`${ require.resolve('webpack-dev-server/client') }?http://${ host }:${ flags.port }/`, require.resolve('webpack/hot/dev-server'), require.resolve('./assets/public-path.js') + '?manual', (0, _resolveToCwd2.default)(filename)]
  };
}
