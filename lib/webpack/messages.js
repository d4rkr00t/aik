...
function devServerBanner(imports, flags, entry, ngrokUrl) {
  var chalk = imports.chalk;
...
function devServerCompiledSuccessfullyMsg(imports, flags, entry, ngrokUrl) {
  var chalk = imports.chalk;
  var log = imports.log;

  var msg = devServerBanner(imports, flags, entry, ngrokUrl);
  msg.push('', chalk.green('Compiled successfully!'));
  return print(imports, msg);
}

function devServerFailedToCompileMsg(imports, flags, entry, ngrokUrl) {
  var chalk = imports.chalk;
  var log = imports.log;
...
function devServerCompiledWithWarningsMsg(imports, flags, entry, ngrokUrl) {
  var chalk = imports.chalk;
  var log = imports.log;
...
function builderBanner(imports, flags, entry) {
  var chalk = imports.chalk;
  var log = imports.log;
