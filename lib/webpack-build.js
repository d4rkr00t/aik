...
function runWebpackBuilder(filename, flags, console) {
  ...
  (0, _webpackMessages.webpackBuilderBanner)(msgImports, filename, flags.cssmodules);
  (0, _webpackMessages.webpackBuilderRemovingDistMsg)(msgImports, dist);

  return removeDist(dist).then(function () {
    (0, _webpackMessages.webpackBuilderRunningBuildMsg)(msgImports);
    compiler.run(function (err) {
      if (err) {
        (0, _webpackMessages.webpackBuilderErrorMsg)(msgImports, err);
        process.exit(1); // eslint-disable-line
      }
      (0, _webpackMessages.webpackBuilderSuccessMsg)(msgImports, distShortName);
    });
  });
}