...
function devServerBanner(filename, flags, params) {
  var msg = [_chalk2.default.green('Watching...'), '', _chalk2.default.magenta('Entry point:      ') + filename];
...
function devServerCompiledSuccessfullyMsg(filename, flags, params) {
  var msg = devServerBanner(filename, flags, params);
...
function builderBanner(filename, flags, params) {
  ...
  var msg = [_chalk2.default.green('Building...'), '', _chalk2.default.magenta('Entry point:     ') + filename];
