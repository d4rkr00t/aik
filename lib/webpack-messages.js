...
exports.devServerSmallBanner = devServerSmallBanner;
...
function devServerSmallBanner(_ref4, flags, ngrokUrl) {
...
function devServerCompiledSuccessfullyMsg(_ref6, flags, ngrokUrl) {
  var log = _ref6.log;
  var chalk = _ref6.chalk;

  var msg = devServerSmallBanner({ chalk: chalk }, flags, ngrokUrl);
  msg.push('', chalk.green('Compiled successfully!'));
  return print({ log: log }, msg);
}

function devServerFailedToCompileMsg(_ref7, flags, ngrokUrl) {
  var log = _ref7.log;
...
function devServerCompiledWithWarningsMsg(_ref8, flags, ngrokUrl) {
  var log = _ref8.log;
