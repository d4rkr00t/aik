...
function setupLoaders(cssmodules) {
  return [{
    ...
    loaders: [makeAbsolutePathToNodeModules('react-hot-loader'), makeAbsolutePathToNodeModules('babel-loader') + '?presets[]=' + makeAbsolutePathToNodeModules('babel-preset-react') + ',presets[]=' + makeAbsolutePathToNodeModules('babel-preset-es2015') + '&cacheDirectory' // eslint-disable-line
    ]
  }];
}
