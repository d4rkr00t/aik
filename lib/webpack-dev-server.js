...
function onDone(imports, flags, filename, ngrokUrl, stats) {
  ...
  if (!hasErrors && !hasWarnings) {
    return (0, _messages.devServerCompiledSuccessfullyMsg)(imports, flags, filename, ngrokUrl);
  }
  ...
  if (hasErrors) {
    (0, _messages.devServerFailedToCompileMsg)(imports, flags, filename, ngrokUrl);
  ...
  if (hasWarnings) {
    (0, _messages.devServerCompiledWithWarningsMsg)(imports, flags, filename, ngrokUrl);
...
function createWebpackDevServer(filename, flags, ngrokUrl) {
  var config = (0, _config2.default)(filename, flags, false, '');
